...
class Connect4GAT(nn.Module):
    def __init__(self, game, args):
        ...
        # Value head
        self.value_conv = nn.Conv2d(args.num_channels, 32, kernel_size=1)
        self.value_bn = nn.BatchNorm2d(32)
        self.value_fc1 = nn.Linear(32 * self.board_x * self.board_y, 256)
    ...
    def _board_to_graph(self, s):
        ...
        # Create edge index for Connect4 board
        edge_index = self._create_connect4_edge_index(self.board_x, self.board_y)
